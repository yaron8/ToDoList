...
public final class Constants {
    ...
    public static final double HOME_LATITUDE = 31.760190;
    public static final double HOME_LONGITUDE = 35.217844;
    public static final float HOME_RADIUS_METERS = 72.0f;
